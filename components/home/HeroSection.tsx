...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* Gradient Overlay */}
      <div
        className="absolute inset-0 bg-gradient-to-br from-teal-primary/10 to-magenta-primary/10"
        aria-hidden="true"
      ></div>
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-20 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              asChild
              size="lg"
              className="bg-teal-primary hover:bg-teal-primary/90 text-white font-semibold px-8 py-6 text-lg group transition-all duration-200 shadow-lg hover:shadow-xl"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-2 border-magenta-primary text-magenta-primary hover:bg-magenta-primary hover:text-white font-semibold px-8 py-6 text-lg transition-all duration-200"
            >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
          ...
          <div className="text-center space-y-2">
            <div className="flex items-center justify-center">
              <Lightbulb
                className="h-8 w-8 text-magenta-primary"
                aria-hidden="true"
              />
            </div>
            <div className="text-3xl font-bold text-neutral-dark tracking-tight">
